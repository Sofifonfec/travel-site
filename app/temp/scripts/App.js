...
var mobileMenu = new _MobileMenu2.default(); /*import a JS file into another JS file. When using "require" no need to specify '.js'
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.siteHeader = (0, _jquery2.default)(".site-header"); //we target the site header to create a modifier class when clicked
		this.menuIcon = (0, _jquery2.default)(".site-header__menu-icon"); //we target the element in the DOM to create an event on it
		this.menuContent = (0, _jquery2.default)(".site-header__menu-content"); //we target the menu content to change its class when clicked
	...
	_createClass(MobileMenu, [{
		...
		value: function toggleTheMenu() {
			//we define a new method to tell the event what we want to happen when the icon is clicked 
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //this line will work as long as we have jquery within our node modules folder
...
var RevealOnScroll = function () {
	function RevealOnScroll(els, offset) {
		...
		//The order of these lines matter. We have to call each method in order 
	...
	_createClass(RevealOnScroll, [{
		...
		value: function hideInitially() {
			//we first have to hide the elements we want to reveal on scroll 
		...
		value: function createWaypoints() {
			...
			this.itemsToReveal.each(function () {
				//We target each element. Everything will run once for each element 
				...
				new Waypoint({ //we have access to the 'waypoint' class which takes 2 properties (element & handler)
					...
					handler: function handler() {
						// What we want to happen to the element 
						(0, _jquery2.default)(currentItem).addClass("reveal-item--is-visible"); // we add a modifier class to make elements visible  
					},
		...
		value: function createPageSectionWaypoints() {
			...
			this.pageSections.each(function () {
				...
				new Waypoint({
					...
					offset: "18%" // to trigger the event on the element earlier when scrolling down
				});
				...
				new Waypoint({
					...
					offset: "-40%" // to trigger the event on the element earlier when scrolling up
				});
			});
		}
	}]);
